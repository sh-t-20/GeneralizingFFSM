					...
					if (fsm_list.size() < 11) {
						...
						for (int k = 1; k < fsm_list.size(); k++) {
							...
							if (k == (fsm_list.size() - 1)) {
								...
								bw.close();
								File fsm_file_2 = new File(output_dir, (fixedLengthString + "_fsm.txt"));
								String header = "";
								if (line.hasOption(HEADER)) {
									// Adding product features to the header of FSM text file
									String[] product_features = new String[features_i.size()];
									int f_index = 0;
									for (String f : features_i) {
										product_features[f_index] = f.toString();
										f_index += 1;
									}
									
									int length = product_features.length;
									for (int i1 = 0; i1 < length; i1++) {
										header += product_features[i1];
										if (i1 != length-1) {
											header += "\t";
										}
									}
								}
								FeaturedMealyUtils.getInstance().saveFSM_kiss(new_mealy, fsm_file_2, header);
							}
						}
					}
				}
...
//					System.out.println("output list:" + output_list);
					String output_string = String.join(",", output_list).replaceAll("\\s", "");
...
//		System.out.println("\n" + Arrays.deepToString(states_map));
	...
	private static FsmResult CreateFSM_List_Basic(List<String> features_1, File fsm_dir_1,
		...
		if (features_1.contains("Finger_Protection")) {
			...
			System.out.println("Finger_Protection:");
			System.out.println(mealy_1.getInputAlphabet());
...
//		}
		if (features_1.contains("Manual_Power_Window") && features_1.contains("Automatic_Power_Window")) {
			...
			CompactMealy<String, Word<String>> mealy_1 = LoadMealy_2(fsm_dir_1, file_name_1);
			System.out.println("Manual_Power_Window, Automatic_Power_Windo:");
			System.out.println(mealy_1.getInputAlphabet());
			fsm_list_1.add(mealy_1);
			fsm_name_list_1.add(file_name_1);
		} else {
			if (features_1.contains("Manual_Power_Window")) {
				...
				CompactMealy<String, Word<String>> mealy_1 = LoadMealy_2(fsm_dir_1, file_name_1);
				System.out.println("Manual_Power_Window:");
				System.out.println(mealy_1.getInputAlphabet());
				fsm_list_1.add(mealy_1);
				fsm_name_list_1.add(file_name_1);
			}
			if (features_1.contains("Automatic_Power_Window")) {
				...
				CompactMealy<String, Word<String>> mealy_1 = LoadMealy_2(fsm_dir_1, file_name_1);
				System.out.println("Automatic_Power_Window:");
				System.out.println(mealy_1.getInputAlphabet());
				fsm_list_1.add(mealy_1);
				fsm_name_list_1.add(file_name_1);
			}
...
//		}
		if (features_1.contains("LED_Power_Window")) {
			...
			if (features_1.contains("Manual_Power_Window")) {
				...
				CompactMealy<String, Word<String>> mealy_1 = LoadMealy_2(fsm_dir_1, file_name_1);
				System.out.println("LED_Power_Window:");
				System.out.println(mealy_1.getInputAlphabet());
				fsm_list_1.add(mealy_1);
				fsm_name_list_1.add(file_name_1);
			}
		...
		if (features_1.contains("Central_Locking_System")) {
			...
			CompactMealy<String, Word<String>> mealy_1 = LoadMealy_2(fsm_dir_1, file_name_1);
			System.out.println("Central_Locking_System:");
			System.out.println(mealy_1.getInputAlphabet());
			fsm_list_1.add(mealy_1);
			fsm_name_list_1.add(file_name_1);
		}
		if (features_1.contains("LED_Finger_Protection")) {
			...
			CompactMealy<String, Word<String>> mealy_1 = LoadMealy_2(fsm_dir_1, file_name_1);
			System.out.println("LED_Finger_Protection:");
			System.out.println(mealy_1.getInputAlphabet());
			fsm_list_1.add(mealy_1);
			fsm_name_list_1.add(file_name_1);
		}
...
//		}
		if (features_1.contains("LED_Central_Locking_System")) {
			...
			CompactMealy<String, Word<String>> mealy_1 = LoadMealy_2(fsm_dir_1, file_name_1);
			System.out.println("LED_Central_Locking_System:");
			System.out.println(mealy_1.getInputAlphabet());
			fsm_list_1.add(mealy_1);
			fsm_name_list_1.add(file_name_1);
		}
		if (features_1.contains("Alarm_System")) {
			...
			CompactMealy<String, Word<String>> mealy_1 = LoadMealy_2(fsm_dir_1, file_name_1);
			System.out.println("Alarm_System:");
			System.out.println(mealy_1.getInputAlphabet());
			fsm_list_1.add(mealy_1);
			fsm_name_list_1.add(file_name_1);
		}
...
//	}
	...
	private static Options createOptions() {
		...
		options.addOption(HEADER, false, "Adding  product features to the header of .txt files");
		return options;
	}
