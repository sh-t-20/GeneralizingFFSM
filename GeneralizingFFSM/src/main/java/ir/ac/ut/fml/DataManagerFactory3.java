...
public class DataManagerFactory3 {
	...
	public DataManagerFactory3(String config_1) {
	...
	public void write_output(StringBuilder buffer, String file_extension) {
		...
		String suffix;
	    if (".txt".equalsIgnoreCase(file_extension)) {
	        suffix = "_text";
	    } else if (".dot".equalsIgnoreCase(file_extension)) {
	        suffix = "_fsm";
	    } else {
	        suffix = ""; // default suffix if needed
	    }
