...
public class FSMVisualizer2 {
	...
	public FSMVisualizer2() {
	}

	public void visualize(FastNFA<String> fsm, DataManagerFactory2 data_manager_factory) {
		set_fsm(fsm);
	...
	private void set_scc_check(DataManagerFactory2 data_manager_factory) {
	...
	private void save_fsm_kiss(DataManagerFactory2 data_manager_factory) {
	...
	private void save_fsm_graph_view(DataManagerFactory2 data_manager_factory) {
		StringBuilder buffer = new StringBuilder();
